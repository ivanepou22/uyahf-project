/// <summary>
/// TableExtension Loan and Advance HeaderExt (ID 50051) extends Record Loan and Advance Header.
/// </summary>
tableextension 50150 "NFL Requisition HeaderExt" extends "NFL Requisition Header"
{
