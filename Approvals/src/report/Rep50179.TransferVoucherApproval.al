...
report 50020 "Transfer Voucher Approval"
{
    ...
    ApplicationArea = All;
    ProcessingOnly = true;
    Caption = 'Transfer Payment Vouchers Approval';
    ...
    dataset
    {
        dataitem("Payment Voucher Header"; "Payment Voucher Header")
        {
            ...
            begin
                "Payment Voucher Header".CalcFields("Current Approver");
                "Payment Voucher Header".SetRange("Current Approver", FromApprover);
            end;

            trigger OnAfterGetRecord()
            begin
                ApprovalEntry.Reset();
                ApprovalEntry.SetRange("Document No.", "Payment Voucher Header"."No.");
