...
/// </summary>
page 50050 "Document Attachments Factbox"
{
                        ...
                        case "Table ID" of
                            ...
                            DATABASE::"NFL Requisition Header":
                                begin
                                    ...
                                    PurchaseRequisitionHeader.SetRange(PurchaseRequisitionHeader."No.", "No.");
                            ...
                            DATABASE::"Payment Voucher Header":
                                begin
                                    ...
                                    PaymentVoucherHeader.SetRange(PaymentVoucherHeader."No.", "No.");
