...
report 50005 "Form 5"
{
    ...
    dataset
    {
        dataitem("NFL Requisition Header"; "NFL Requisition Header")
        {
            ...
            column(AccountingPeriodStartDate_NFLRequisitionHeader; "NFL Requisition Header"."Accounting Period Start Date")
            {
            }
            column(FiscalYearEndDate_NFLRequisitionHeader; "NFL Requisition Header"."Fiscal Year End Date")
            {
            }
            column(FiscalYearStartDate_NFLRequisitionHeader; "NFL Requisition Header"."Fiscal Year Start Date")
            {
            }
            ...
            column(WrksSrvcsSup_NFLRequisitionHeader; "NFL Requisition Header"."Wrks/Srvcs/Sup")
            {
            }
            ...
            dataitem("NFL Requisition Line"; "NFL Requisition Line")
            {
                ...
                column(LineAmount_NFLRequisitionLine; "NFL Requisition Line"."Line Amount")
                {
                }
                column(AmountIncludingVAT_NFLRequisitionLine; "NFL Requisition Line"."Amount Including VAT")
                {
                }
            ...
            begin
                ...
                IF "NFL Requisition Header"."Location Code" <> '' THEN BEGIN
                    LocRec.GET("NFL Requisition Header"."Location Code");
                ...
                IF ApproverRec.FINDFIRST THEN
                    REPEAT
                        ...
                        IF User.FINDFIRST THEN
                            // Employee.SETRANGE("No.", User."Employee ID");
