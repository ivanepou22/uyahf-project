...
table 50001 "Payment Voucher Header"
{
    ...
    /// </summary>
    /// <param name="PaymentVoucherHeader">Parameter of type Record "51402242".</param>
    procedure ArchiveVoucher(PaymentVoucherHeader: Record "Payment Voucher Header");
    begin
        PaymentVoucherHeader.TestField("Transferred to Journals", true);
        PaymentVoucherHeader.TestField(Archieved, false);
        PaymentVoucherHeader.Validate(Archieved, true);
        PaymentVoucherHeader.Modify();
        Message('Payment Voucher %1 has been archived Successfully.', PaymentVoucherHeader."No.");
    end;
