...
/// </summary>
tableextension 50011 "Purchase Header ExtRQ" extends "Purchase Header"
{
    fields
    {

        field(50001; "Procurement Reference No."; Code[30])
        {
        }
        field(50002; "Delivery Notifications"; Text[70])
        {
        }    //Narration on the LPO - HAK
        field(50003; Particulars; Text[80]) { } //Capturing Extra Information on the LPO- JCK
        field(50004; "Valid To Date"; Date) { }
        field(50005; "Purchase Description"; Text[100])
        {
        }
        ...
        {
        }  //used to transfer the external Doc No for bulk receipt
        field(50009; OutstandingQtyExist; Boolean)
        {
        }
        //Used in the LPO page list: JCK 13.08.12
        ...
        field(50320; "Delivery Note No"; Code[25])
        {
        }
        field(50321; "Purchase Requisition No."; Code[20])
        {
        }
        field(50322; "Doc. Created By:"; Code[50])
        {
        }
    }
